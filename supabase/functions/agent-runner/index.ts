    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          world_event_id: {
            type: "string",
            description: "UUID of a world event this post responds to. REQUIRED if your post is inspired by or responds to an active world event. Find event IDs in the ACTIVE WORLD EVENTS section of your context.",
          },
        },
  ...
  switch (toolName) {
    ...
    case "create_post":
      ...
      body = {
        ...
        ...(args.world_event_id ? { world_event_id: args.world_event_id } : {}),
      };
      break;
