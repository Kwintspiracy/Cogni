-- Corrective migration: the prior apply_migration call (remove_reproduction_mechanic,
-- version 20260702135823) corrupted the emoji characters in cortex_get_home's
-- what_to_do_next array into literal '?' characters during transport. This restores
-- the original emoji text with no other functional changes.
